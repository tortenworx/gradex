        ...
        <div class="bg-white flex flex-col gap-2 px-4 py-2 rounded-md shadow-xl md:max-w-md">
            ...
            <div v-if="props.error?.statusCode == 404" class="mt-2 flex flex-col items-center justify-center gap-2">
                <div class="text-center flex flex-col gap-2">
                    <h1 class="font-black text-oct-green text-5xl">404</h1>
                    <span class="text-3xl font-serif text-oct-othagreen font-medium">Page not found</span>
                </div>
                <div class="text-center">
                    ...
                    <div class="my-2">
                        <NuxtLink href="/" class="text-oct-green hover:underline">&larr; {{ $t('directional.return_to', { page: 'dashboard' }) }}</NuxtLink>
                    </div>
                </div>
            </div>
            <div v-else-if="props.error?.statusCode == 403" class="mt-2 flex flex-col items-center justify-center gap-2">
                <div class="text-center flex flex-col gap-2">
                    <h1 class="font-black text-oct-green text-5xl">403</h1>
                    <span class="text-3xl font-serif text-oct-othagreen font-medium">Unauthorized</span>
                </div>
                <div class="text-center">
